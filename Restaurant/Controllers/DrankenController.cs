...
namespace Restaurant.Controllers
{
    ...
    public class DrankenController : Controller
    {
        ...
        public DrankenController(IUnitOfWork unitOfWork, IMapper mapper)
        {
            _uow = unitOfWork;
            _mapper = mapper;
        }
        ...
        {
            // Haal de producten op van CategorieType met TypeId = 1 (Drank)
            IEnumerable<Product> producten = await _uow.ProductRepository.GetProductsByCategorieTypeAsync(1);
        ...
        // GET: Dranken/Details/id
        public async Task<IActionResult> Details(int id)
        {
            Product model = await _uow.ProductRepository.GetByIdAsync(id);

            if (model == null || model.Categorie == null || model.Categorie.TypeId != 1)
            {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            {
                Actief = true,
                Categorieën = await BuildCategorieSelectListAsync(1)
            };
        ...
        public async Task<IActionResult> Create(ProductCreateViewModel viewmodel)
        {
            ...
            {
                viewmodel.Categorieën = await BuildCategorieSelectListAsync(1);
                return View(viewmodel);
            }
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            if (product == null || product.Categorie.TypeId != 1)
            {
