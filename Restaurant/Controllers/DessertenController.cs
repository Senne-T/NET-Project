...
namespace Restaurant.Controllers
{
    ...
    public class DessertenController : Controller
    {
        private IUnitOfWork _uow;
        private IMapper _mapper;

        public DessertenController(IUnitOfWork unitOfWork, IMapper mapper)
        {
            _uow = unitOfWork;
            _mapper = mapper;
        }
        ...
        {
            // Haal de producten op van CategorieType met TypeId = 3 (Dessert)
            IEnumerable<Product> producten = await _uow.ProductRepository.GetProductsByCategorieTypeAsync(3);
        ...
        // GET: Desserten/Details/id
        public async Task<IActionResult> Details(int id)
        {
            Product model = await _uow.ProductRepository.GetByIdAsync(id);

            if (model == null || model.Categorie == null || model.Categorie.TypeId != 3)
            {
        ...
        // GET: Desserten/Create
        public async Task<IActionResult> Create()
        {
            var model = new ProductCreateViewModel
            {
                Actief = true,
                Categorieën = await BuildCategorieSelectListAsync(3)
            };

            return View(model);
        }

        // POST: Desserten/Create
        [HttpPost]
        ...
        public async Task<IActionResult> Create(ProductCreateViewModel viewmodel)
        {
            ...
            {
                viewmodel.Categorieën = await BuildCategorieSelectListAsync(3);
                return View(viewmodel);
            }
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            if (product == null || product.Categorie.TypeId != 3)
            {
