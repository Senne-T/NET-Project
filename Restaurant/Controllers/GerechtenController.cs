...
namespace Restaurant.Controllers
{
    ...
    public class GerechtenController : Controller
    {
        ...
        public GerechtenController(IUnitOfWork unitOfWork, IMapper mapper)
        {
            _uow = unitOfWork;
            _mapper = mapper;
        }
        ...
        {
            // Haal de producten op van CategorieType met TypeId = 2 (Gerecht)
            IEnumerable<Product> producten = await _uow.ProductRepository.GetProductsByCategorieTypeAsync(2);
        ...
        // GET: Gerechten/Details/id
        public async Task<IActionResult> Details(int id)
        {
            Product model = await _uow.ProductRepository.GetByIdAsync(id);

            if (model == null || model.Categorie == null || model.Categorie.TypeId != 2)
            {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            {
                Actief = true,
                Categorieën = await BuildCategorieSelectListAsync(2)
            };
        ...
        public async Task<IActionResult> Create(ProductCreateViewModel viewmodel)
        {
            ...
            {
                viewmodel.Categorieën = await BuildCategorieSelectListAsync(2);
                return View(viewmodel);
            }
